    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:mx-0 text-center lg:text-left">
          ...
          >
            MySchool-মাইস্কুল-এ, আমরা বিশ্বাস করি যে, তরুণ মনগুলি দায়িত্বশীল, উদ্ভাবনী এবং সহানুভূতিশীল ব্যক্তিত্বে পরিণত হতে সাহায্য করতে হবে। আমাদের লক্ষ্য হল এমন একটি পূর্ণাঙ্গ শিক্ষা প্রদান করা যা শিক্ষার্থীদের আগামী দিনের চ্যালেঞ্জগুলির জন্য প্রস্তুত করবে।
          </motion.p>
        </div>
...
<div className="p-6 sm:p-10 flex flex-col items-center text-center lg:flex lg:flex-col">
  ...
  <div className="mt-6 lg:mt-6 max-w-3xl">
    ...
    >
      "শিক্ষা শুধু একাডেমিক উৎকর্ষতা সম্পর্কে নয়; এটি চরিত্র গঠন, সৃজনশীলতা উত্সাহিত করা, এবং এমন মূল্যবোধ প্রতিষ্ঠা করার বিষয় যা আমাদের শিক্ষার্থীদের সারা জীবনের পথে নির্দেশনা দেবে। MySchool-মাইস্কুল-এ, আমরা একটি পরিবেশ তৈরি করতে প্রতিশ্রুতিবদ্ধ যেখানে প্রতিটি ছাত্র তার পূর্ণ সম্ভাবনায় পৌঁছাতে পারে।"
    </motion.p>
  </div>
</div>
        </motion.div>
