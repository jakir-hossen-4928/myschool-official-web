...
const FundTracker = () => {
          ...
          <head>
            ...
            <style>
              ...
              @media (max-width: 768px) {
                ...
                .details td { font-size: 12px; padding: 5px; }
            ...
            <div class="container">
              ...
              <div class="details">
                <table>
                  ...
                  <tr><td>Amount:</td><td>৳${Number(transaction.amount).toFixed(2)}</td></tr>
                  <tr><td>Type:</td><td>${transaction.type.charAt(0).toUpperCase() + transaction.type.slice(1)}</td></tr>
  ...
  const generateAllTransactionsPDF = () => {
    const exportDate = new Date().toLocaleString();
    const printWindow = window.open('', '_blank');
    if (printWindow) {
      printWindow.document.write(`
        <html>
          <head>
            <title>MySchool-মাইস্কুল - All Transactions</title>
            <style>
              @media print { @page { margin: 2cm; } }
              body { font-family: Arial, sans-serif; margin: 0; padding: 20px; color: #333; }
              .container { max-width: 1000px; margin: 0 auto; border: 1px solid #ddd; }
              .header { text-align: center; background: #3498db; color: white; padding: 15px; }
              .header h1 { margin: 0; font-size: 28px; }
              .summary { padding: 15px; background: #f8f9fa; border-bottom: 1px solid #ddd; font-size: 14px; }
              ...
              .signature { margin-top: 40px; text-align: right; }
              .signature-line { border-top: 1px solid #000; width: 200px; margin-top: 20px; }
              .footer { text-align: center; padding: 10px; border-top: 1px solid #ddd; color: #777; font-size: 12px; }
              @media (max-width: 768px) {
                table, th, td { font-size: 11px; padding: 8px; }
                .header h1 { font-size: 20px; }
                .signature-line { width: 150px; }
              }
            </style>
        ...
        <html>
          <head>
            ...
            <style>
              ...
              .header { text-align: center; background: #3498db; color: white; padding: 15px; }
              .header h1 { margin: 0; font-size: 28px; }
              .filters, .summary { padding: 15px; background: #f8f9fa; border-bottom: 1px solid #ddd; font-size: 14px; }
              table { width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 13px; }
              th, td { border: 1px solid #ddd; padding: 10px; text-align: left; }
              th { background: #2c3e50; color: white; }
              tr:nth-child(even) { background: #f9f9f9; }
